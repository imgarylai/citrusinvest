---
title: "Strategy envelope"
editUrl: false
sourceFile: docs/strategy-envelope.md
---

<!-- Imported from docs/strategy-envelope.md by site/scripts/import-reference-docs.mjs — edit the source, then re-run `npm run import:docs`. -->
