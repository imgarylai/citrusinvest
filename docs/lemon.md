...
[data-layout tree](./data-layout.md) in one step — and naming a strategy file
...
- `index` is a **named point-in-time universe** (`#! index: sp500` /
  ...
  [data-layout.md §8](./data-layout.md) for the hold-vs-mask subtlety.
...
`lemon run strategy.json` runs a [strategy envelope](./strategy-envelope.md)
