# Finnhub data source for citrusquant
...
[`data-layout`](data-layout.md) tree as FMP/EODHD/Alpha Vantage. Stance, block
comparison, and assemble recipes: [`data-sources.md`](data-sources.md).
...
- Mapping research: [`data-sources.md`](data-sources.md) § Finnhub
...
- [`fmp-data-source.md`](fmp-data-source.md) · [`eodhd-data-source.md`](eodhd-data-source.md) · [`alpha-vantage-data-source.md`](alpha-vantage-data-source.md)  
