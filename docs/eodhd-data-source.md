...
[`fmp-data-source.md`](fmp-data-source.md) — the same panel requirements apply
...
- Mapping research: [`data-sources.md`](data-sources.md) § EODHD
...
- [`data-sources.md`](data-sources.md) — multi-source stance  
- [`fmp-data-source.md`](fmp-data-source.md) — FMP path + Starter gaps  
